...
class BleClient(private val context: Context) {
    ...
    companion object {
        // ── Change these to match your firmware ──
    ...
    /** Raw millivolts from the ADC (signed 16-bit). */
    private val _latestMv = MutableStateFlow<Int?>(null)
    val latestMv: StateFlow<Int?> = _latestMv

    /** Whether we currently hold an open GATT connection. */
    ...
    private val gattCallback = object : BluetoothGattCallback() {
        ...
        override fun onServicesDiscovered(g: BluetoothGatt, status: Int) {
            ...
            if (ch == null) {
                _state.value = BleState.Error("Characteristic not found")
                return
            }
        ...
        override fun onCharacteristicChanged(
            ...
            if (characteristic.uuid == CHAR_UUID) decodeAndPublish(value)
        }
        ...
        override fun onCharacteristicChanged(
            ...
            if (characteristic.uuid == CHAR_UUID) decodeAndPublish(characteristic.value ?: return)
        }
