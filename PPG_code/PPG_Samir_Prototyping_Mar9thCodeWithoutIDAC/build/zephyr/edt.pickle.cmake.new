...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/adc@40007000/channel@1|zephyr,differential" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/adc@40007000/channel@1|zephyr,input-positive" "5")
